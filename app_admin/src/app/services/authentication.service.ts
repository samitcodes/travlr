...
export class AuthenticationService {
  ...
  // NOTE: For this application we name the key 'travlr-token'
  ...
  // Boolean to determine if we are logged in and token is valid
  ...
  // Should be called after checking isLoggedIn()
  ...
  // Functionally similar to login since API logs in immediately after registration
